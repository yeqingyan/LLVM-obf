; ModuleID = '/home/alan/workspace/playground/Box2D/Box2D/Box2D/Dynamics/Contacts/b2PolygonAndCircleContact.cpp'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.b2PolygonAndCircleContact = type { %class.b2Contact.base, [4 x i8] }
...
@_ZTV25b2PolygonAndCircleContact = unnamed_addr constant [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI25b2PolygonAndCircleContact to i8*), i8* bitcast (void (%class.b2PolygonAndCircleContact*, %struct.b2Manifold*, %struct.b2Transform*, %struct.b2Transform*)* @_ZN25b2PolygonAndCircleContact8EvaluateEP10b2ManifoldRK11b2TransformS4_ to i8*), i8* bitcast (void (%class.b2PolygonAndCircleContact*)* @_ZN25b2PolygonAndCircleContactD2Ev to i8*), i8* bitcast (void (%class.b2PolygonAndCircleContact*)* @_ZN25b2PolygonAndCircleContactD0Ev to i8*)], align 8
@.str = private unnamed_addr constant [44 x i8] c"m_fixtureA->GetType() == b2Shape::e_polygon\00", align 1
@.str.1 = private unnamed_addr constant [98 x i8] c"/home/alan/workspace/playground/Box2D/Box2D/Box2D/Dynamics/Contacts/b2PolygonAndCircleContact.cpp\00", align 1
...
@.str.2 = private unnamed_addr constant [43 x i8] c"m_fixtureB->GetType() == b2Shape::e_circle\00", align 1
...
@_ZN25b2PolygonAndCircleContactC1EP9b2FixtureS1_ = alias void (%class.b2PolygonAndCircleContact*, %class.b2Fixture*, %class.b2Fixture*), void (%class.b2PolygonAndCircleContact*, %class.b2Fixture*, %class.b2Fixture*)* @_ZN25b2PolygonAndCircleContactC2EP9b2FixtureS1_
...
define %class.b2Contact* @_ZN25b2PolygonAndCircleContact6CreateEP9b2FixtureiS1_iP16b2BlockAllocator(%class.b2Fixture* %fixtureA, i32, %class.b2Fixture* %fixtureB, i32, %class.b2BlockAllocator* %allocator) #0 align 2 {
  ...
  %11 = bitcast i8* %10 to %class.b2PolygonAndCircleContact*
  %12 = load %class.b2Fixture*, %class.b2Fixture** %3, align 8
  %13 = load %class.b2Fixture*, %class.b2Fixture** %5, align 8
  call void @_ZN25b2PolygonAndCircleContactC1EP9b2FixtureS1_(%class.b2PolygonAndCircleContact* %11, %class.b2Fixture* %12, %class.b2Fixture* %13)
  %14 = bitcast %class.b2PolygonAndCircleContact* %11 to %class.b2Contact*
...
define void @_ZN25b2PolygonAndCircleContact7DestroyEP9b2ContactP16b2BlockAllocator(%class.b2Contact* %contact, %class.b2BlockAllocator* %allocator) #0 align 2 {
  ...
  %4 = bitcast %class.b2Contact* %3 to %class.b2PolygonAndCircleContact*
  %5 = bitcast %class.b2PolygonAndCircleContact* %4 to void (%class.b2PolygonAndCircleContact*)***
  %6 = load void (%class.b2PolygonAndCircleContact*)**, void (%class.b2PolygonAndCircleContact*)*** %5, align 8
  %7 = getelementptr inbounds void (%class.b2PolygonAndCircleContact*)*, void (%class.b2PolygonAndCircleContact*)** %6, i64 1
  %8 = load void (%class.b2PolygonAndCircleContact*)*, void (%class.b2PolygonAndCircleContact*)** %7, align 8
  call void %8(%class.b2PolygonAndCircleContact* %4)
...
; Function Attrs: uwtable
define void @_ZN25b2PolygonAndCircleContactC2EP9b2FixtureS1_(%class.b2PolygonAndCircleContact* %this, %class.b2Fixture* %fixtureA, %class.b2Fixture* %fixtureB) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = alloca %class.b2PolygonAndCircleContact*, align 8
  %2 = alloca %class.b2Fixture*, align 8
  %3 = alloca %class.b2Fixture*, align 8
  %4 = alloca i8*
  %5 = alloca i32
  store %class.b2PolygonAndCircleContact* %this, %class.b2PolygonAndCircleContact** %1, align 8
  store %class.b2Fixture* %fixtureA, %class.b2Fixture** %2, align 8
  store %class.b2Fixture* %fixtureB, %class.b2Fixture** %3, align 8
  %6 = load %class.b2PolygonAndCircleContact*, %class.b2PolygonAndCircleContact** %1, align 8
  %7 = bitcast %class.b2PolygonAndCircleContact* %6 to %class.b2Contact*
  ...
  %10 = bitcast %class.b2PolygonAndCircleContact* %6 to i32 (...)***
  ...
  %11 = bitcast %class.b2PolygonAndCircleContact* %6 to %class.b2Contact*
...
; <label>:18                                      ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i32 0, i32 0), i32 40, i8* getelementptr inbounds ([79 x i8], [79 x i8]* @__PRETTY_FUNCTION__._ZN25b2PolygonAndCircleContactC2EP9b2FixtureS1_, i32 0, i32 0)) #8
  unreachable
...
; <label>:19                                      ; preds = %25, %0
  ...
  %23 = bitcast %class.b2PolygonAndCircleContact* %6 to %class.b2Contact*
...
; <label>:25                                      ; preds = %24, %17
  %26 = bitcast %class.b2PolygonAndCircleContact* %6 to %class.b2Contact*
...
; <label>:33                                      ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i32 0, i32 0), i32 41, i8* getelementptr inbounds ([79 x i8], [79 x i8]* @__PRETTY_FUNCTION__._ZN25b2PolygonAndCircleContactC2EP9b2FixtureS1_, i32 0, i32 0)) #8
  unreachable
                                                  ; No predecessors!
  br label %35
...
; Function Attrs: uwtable
define void @_ZN25b2PolygonAndCircleContact8EvaluateEP10b2ManifoldRK11b2TransformS4_(%class.b2PolygonAndCircleContact* %this, %struct.b2Manifold* %manifold, %struct.b2Transform* dereferenceable(16) %xfA, %struct.b2Transform* dereferenceable(16) %xfB) unnamed_addr #0 align 2 {
  %1 = alloca %class.b2PolygonAndCircleContact*, align 8
  ...
  %5 = load %class.b2PolygonAndCircleContact*, %class.b2PolygonAndCircleContact** %1, align 8
  %6 = load %struct.b2Manifold*, %struct.b2Manifold** %2, align 8
  %7 = bitcast %class.b2PolygonAndCircleContact* %5 to %class.b2Contact*
  ...
  %13 = bitcast %class.b2PolygonAndCircleContact* %5 to %class.b2Contact*
...
declare void @_Z25b2CollidePolygonAndCircleP10b2ManifoldPK14b2PolygonShapeRK11b2TransformPK13b2CircleShapeS6_(%struct.b2Manifold*, %class.b2PolygonShape*, %struct.b2Transform* dereferenceable(16), %class.b2CircleShape*, %struct.b2Transform* dereferenceable(16)) #1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN25b2PolygonAndCircleContactD2Ev(%class.b2PolygonAndCircleContact* %this) unnamed_addr #4 comdat align 2 {
  %1 = alloca %class.b2PolygonAndCircleContact*, align 8
  store %class.b2PolygonAndCircleContact* %this, %class.b2PolygonAndCircleContact** %1, align 8
  %2 = load %class.b2PolygonAndCircleContact*, %class.b2PolygonAndCircleContact** %1, align 8
  %3 = bitcast %class.b2PolygonAndCircleContact* %2 to %class.b2Contact*
  call void @_ZN9b2ContactD2Ev(%class.b2Contact* %3)
  ret void
}

; Function Attrs: uwtable
define linkonce_odr void @_ZN25b2PolygonAndCircleContactD0Ev(%class.b2PolygonAndCircleContact* %this) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = alloca %class.b2PolygonAndCircleContact*, align 8
  %2 = alloca i8*
  %3 = alloca i32
  store %class.b2PolygonAndCircleContact* %this, %class.b2PolygonAndCircleContact** %1, align 8
  %4 = load %class.b2PolygonAndCircleContact*, %class.b2PolygonAndCircleContact** %1, align 8
  invoke void @_ZN25b2PolygonAndCircleContactD2Ev(%class.b2PolygonAndCircleContact* %4)
          to label %5 unwind label %7

; <label>:5                                       ; preds = %0
  %6 = bitcast %class.b2PolygonAndCircleContact* %4 to i8*
...
; <label>:7                                       ; preds = %0
  ...
  %11 = bitcast %class.b2PolygonAndCircleContact* %4 to i8*
