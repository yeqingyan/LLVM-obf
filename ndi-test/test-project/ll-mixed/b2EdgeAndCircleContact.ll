; ModuleID = '/home/alan/workspace/playground/Box2D/Box2D/Box2D/Dynamics/Contacts/b2EdgeAndCircleContact.cpp'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.b2EdgeAndCircleContact = type { %class.b2Contact.base, [4 x i8] }
...
@_ZN22b2EdgeAndCircleContactC1EP9b2FixtureS1_ = alias void (%class.b2EdgeAndCircleContact*, %class.b2Fixture*, %class.b2Fixture*), void (%class.b2EdgeAndCircleContact*, %class.b2Fixture*, %class.b2Fixture*)* @_ZN22b2EdgeAndCircleContactC2EP9b2FixtureS1_
...
define %class.b2Contact* @_ZN22b2EdgeAndCircleContact6CreateEP9b2FixtureiS1_iP16b2BlockAllocator(%class.b2Fixture* %fixtureA, i32, %class.b2Fixture* %fixtureB, i32, %class.b2BlockAllocator* %allocator) #0 align 2 {
  ...
  %11 = bitcast i8* %10 to %class.b2EdgeAndCircleContact*
  %12 = load %class.b2Fixture*, %class.b2Fixture** %3, align 8
  %13 = load %class.b2Fixture*, %class.b2Fixture** %5, align 8
  call void @_ZN22b2EdgeAndCircleContactC1EP9b2FixtureS1_(%class.b2EdgeAndCircleContact* %11, %class.b2Fixture* %12, %class.b2Fixture* %13)
  %14 = bitcast %class.b2EdgeAndCircleContact* %11 to %class.b2Contact*
...
define void @_ZN22b2EdgeAndCircleContact7DestroyEP9b2ContactP16b2BlockAllocator(%class.b2Contact* %contact, %class.b2BlockAllocator* %allocator) #0 align 2 {
  ...
  %6 = load void (%class.b2EdgeAndCircleContact*)**, void (%class.b2EdgeAndCircleContact*)*** %5, align 8
  %7 = getelementptr inbounds void (%class.b2EdgeAndCircleContact*)*, void (%class.b2EdgeAndCircleContact*)** %6, i64 1
  %8 = load void (%class.b2EdgeAndCircleContact*)*, void (%class.b2EdgeAndCircleContact*)** %7, align 8
...
; Function Attrs: uwtable
define void @_ZN22b2EdgeAndCircleContactC2EP9b2FixtureS1_(%class.b2EdgeAndCircleContact* %this, %class.b2Fixture* %fixtureA, %class.b2Fixture* %fixtureB) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = alloca %class.b2EdgeAndCircleContact*, align 8
  %2 = alloca %class.b2Fixture*, align 8
  %3 = alloca %class.b2Fixture*, align 8
  %4 = alloca i8*
  %5 = alloca i32
  store %class.b2EdgeAndCircleContact* %this, %class.b2EdgeAndCircleContact** %1, align 8
  store %class.b2Fixture* %fixtureA, %class.b2Fixture** %2, align 8
  store %class.b2Fixture* %fixtureB, %class.b2Fixture** %3, align 8
  %6 = load %class.b2EdgeAndCircleContact*, %class.b2EdgeAndCircleContact** %1, align 8
  ...
  %10 = bitcast %class.b2EdgeAndCircleContact* %6 to i32 (...)***
...
; <label>:18                                      ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i32 0, i32 0), i32 40, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @__PRETTY_FUNCTION__._ZN22b2EdgeAndCircleContactC2EP9b2FixtureS1_, i32 0, i32 0)) #8
  unreachable
...
; <label>:33                                      ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i32 0, i32 0), i32 41, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @__PRETTY_FUNCTION__._ZN22b2EdgeAndCircleContactC2EP9b2FixtureS1_, i32 0, i32 0)) #8
  unreachable
                                                  ; No predecessors!
  br label %35
...
; Function Attrs: uwtable
define void @_ZN22b2EdgeAndCircleContact8EvaluateEP10b2ManifoldRK11b2TransformS4_(%class.b2EdgeAndCircleContact* %this, %struct.b2Manifold* %manifold, %struct.b2Transform* dereferenceable(16) %xfA, %struct.b2Transform* dereferenceable(16) %xfB) unnamed_addr #0 align 2 {
  %1 = alloca %class.b2EdgeAndCircleContact*, align 8
  ...
  %5 = load %class.b2EdgeAndCircleContact*, %class.b2EdgeAndCircleContact** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN22b2EdgeAndCircleContactD2Ev(%class.b2EdgeAndCircleContact* %this) unnamed_addr #4 comdat align 2 {
  %1 = alloca %class.b2EdgeAndCircleContact*, align 8
  store %class.b2EdgeAndCircleContact* %this, %class.b2EdgeAndCircleContact** %1, align 8
  %2 = load %class.b2EdgeAndCircleContact*, %class.b2EdgeAndCircleContact** %1, align 8
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN22b2EdgeAndCircleContactD0Ev(%class.b2EdgeAndCircleContact* %this) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = alloca %class.b2EdgeAndCircleContact*, align 8
  %2 = alloca i8*
  %3 = alloca i32
  store %class.b2EdgeAndCircleContact* %this, %class.b2EdgeAndCircleContact** %1, align 8
  %4 = load %class.b2EdgeAndCircleContact*, %class.b2EdgeAndCircleContact** %1, align 8
  invoke void @_ZN22b2EdgeAndCircleContactD2Ev(%class.b2EdgeAndCircleContact* %4)
