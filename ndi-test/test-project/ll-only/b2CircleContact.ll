; ModuleID = '/home/alan/workspace/playground/Box2D/Box2D/Box2D/Dynamics/Contacts/b2CircleContact.cpp'
...
@.str = private unnamed_addr constant [43 x i8] c"m_fixtureA->GetType() == b2Shape::e_circle\00", align 1
@.str.1 = private unnamed_addr constant [88 x i8] c"/home/alan/workspace/playground/Box2D/Box2D/Box2D/Dynamics/Contacts/b2CircleContact.cpp\00", align 1
...
; <label>:18                                      ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i32 0, i32 0), i32 43, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__._ZN15b2CircleContactC2EP9b2FixtureS1_, i32 0, i32 0)) #8
  unreachable
...
; <label>:33                                      ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i32 0, i32 0), i32 44, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__._ZN15b2CircleContactC2EP9b2FixtureS1_, i32 0, i32 0)) #8
  unreachable
                                                  ; No predecessors!
  br label %35
...
declare void @_Z16b2CollideCirclesP10b2ManifoldPK13b2CircleShapeRK11b2TransformS3_S6_(%struct.b2Manifold*, %class.b2CircleShape*, %struct.b2Transform* dereferenceable(16), %class.b2CircleShape*, %struct.b2Transform* dereferenceable(16)) #1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN15b2CircleContactD2Ev(%class.b2CircleContact* %this) unnamed_addr #4 comdat align 2 {
  %1 = alloca %class.b2CircleContact*, align 8
  store %class.b2CircleContact* %this, %class.b2CircleContact** %1, align 8
